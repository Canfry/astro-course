...
<button on:click={handleEmojiReaction} class={`w-16 flex gap-x-1 justify-center items-center text-gray-500 cursor-pointer hover:scale-110 transition-transform ${reacted ? 'text-teal-700 border-2 border-teal-900 bg-teal-50 py-3 rounded-full' : ''}`}>
